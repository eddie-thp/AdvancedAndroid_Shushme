...
public class MainActivity extends AppCompatActivity implements
    ...
    private boolean mIsGeofencesEnabled;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsGeofencesEnabled = getPreferences(MODE_PRIVATE).getBoolean(getString(R.string.setting_enabled), false);
        onOffSwitch.setChecked(mIsGeofencesEnabled);
        onOffSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                SharedPreferences.Editor editor = getPreferences(MODE_PRIVATE).edit();
                editor.putBoolean(getString(R.string.setting_enabled), isChecked);
                mIsGeofencesEnabled = isChecked;
                editor.commit();
